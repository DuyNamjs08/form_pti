...
import { FormControl, FormHelperText, IconButton, OutlinedInput, InputLabel } from '@mui/material';
...
const RegexTextField = ({ isRequired,
    isMultiline,
    keyboard,
    initValue,
    label,
    ...
    >
        ...
        <OutlinedInput
            ...
            label={label}
            variant="outlined"
            inputProps={{ style: { textTransform: isUppercase === true ? "uppercase" : "", textAlign: textAlign } }}
